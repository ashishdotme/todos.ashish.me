...
<!-- month starts --><b>Month</b> - 22 tasks completed (Dec 2020)<br><!-- month ends -->
<!-- year starts --><b>Year</b> - 79 tasks completed (Year 2020)<!-- year ends -->

## Todos

<!-- todos starts -->
◻️  &nbsp; Backup photo<br>◻️  &nbsp; Update readmes with social links<br>◻️  &nbsp; Fix laptop bag<br>◻️  &nbsp; Setup alfred workflows<br>◻️  &nbsp; Solve leetcode 606<br>◻️  &nbsp; Read “the old man and the sea”<br>◻️  &nbsp; Oreilly reactive spring boot chapter 5<br>◻️  &nbsp; Create a cli for common tasks
<!-- todos ends -->
